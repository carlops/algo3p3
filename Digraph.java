/**
 * Clase abstracta que implemena un grafo dirigido, las
 * 	aristas son instancias de la clase Edge
 */
public abstract class Digraph {
   ...
   /**
	* Chequea que el grafo contiene una nodo con id nod
	*/
	...
	*/
    public abstract int getInDegree(String node);
    
   /**
	* Retorna el out-degree del vertice dado. Si el
	* vertice no existe, retorna -1.
	*/
    public abstract int getOutDegree(String node);
